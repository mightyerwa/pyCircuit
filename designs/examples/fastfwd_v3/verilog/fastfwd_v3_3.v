...
module fastfwd_v3_3 (
    ...
    input  wire [128*4-1:0] lane_pkt_in_data,
    input  wire [5*4-1:0] lane_pkt_in_ctrl,
    
    // FE feedback ports
    input  wire [3:0] fwded_pkt_data_vld,
    input  wire [128*4-1:0] fwded_pkt_data,
    
    // Output ports - 4 lanes
    output reg  [3:0] lane_pkt_out_vld,
    output reg  [128*4-1:0] lane_pkt_out_data,
    
    // FE control outputs
    output reg  [3:0] fwd_pkt_data_vld,
    output reg  [128*4-1:0] fwd_pkt_data,
    output reg  [2*4-1:0] fwd_pkt_lat,
    output reg  [3:0] fwd_pkt_dp_vld,
    output reg  [128*4-1:0] fwd_pkt_dp_data,
