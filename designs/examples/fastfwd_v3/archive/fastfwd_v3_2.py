...
@module
def fastfwd_v3_2(m: Circuit) -> None:
    """FastFWD V3.2 - 多FE支持"""
    ...
    for i in range(8):
        should_write = fe_done & (tail_ptr == u(3, i))
    ...
    rob_tail.set((tail_ptr + u(3, 1)) & u(3, 0x7) if fe_done else tail_ptr)
...
fastfwd_v3_2.__pycircuit_name__ = "fastfwd_v3_2"


if __name__ == "__main__":
    from pycircuit import compile
    circuit = compile(fastfwd_v3_2, name="fastfwd_v3_2")
